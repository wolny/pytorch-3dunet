...
class EmbeddingOrigWGANTrainerBuilder:
    @staticmethod
    def build(config):
        ...
        if pre_trained is not None:
            ...
            return EmbeddingOrigWGANTrainer.from_pretrained_emb(
                G=G,
                D=D,
            ...
            return EmbeddingOrigWGANTrainer(
                G=G,
                D=D,
                G_optimizer=G_optimizer,
                D_optimizer=D_optimizer,
...
class EmbeddingOrigWGANTrainer:
    ...
    def train(self):
        ...
        D_loss_real = RunningAverage()
        D_loss_fake = RunningAverage()
        ...
        for t in self.loaders['train']:
            ...
            if self.num_iterations % self.log_after_iters == 0:
                ...
                self.writer.add_scalar('train_D_loss_real', D_loss_real.avg, self.num_iterations)
                self.writer.add_scalar('train_D_loss_fake', D_loss_fake.avg, self.num_iterations)
